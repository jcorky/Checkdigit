...
const excludeDirs = [
  ...
  resolve(source, "checkdigit", "workspace-ui"),
];
const excludeFiles = ["fleet_*.csv", "fleet_*.edi", "fleet_*.xml", "fleet_*.csv.truth.json", "fleet_*.edi.truth.json", "fleet_*.xml.truth.json"];
const run = spawnSync(
  "robocopy",
